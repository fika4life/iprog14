...
var DinnerModel = function() {
	...
	this.setDishesToShow = function(dishes) {
		dishesToShow = dishes;
		notifyObservers();
	}

	this.setId = function(i) {
		this.idOfDish = parseInt(i);
		notifyObservers();
	}
	...
	this.getTotalMenuPrice = function() {
		...
		return this.getPriceHelper(ingredients) * this.getNumberOfGuests();
	}

	this.getPriceHelper = function(ingredients) {
		var sum = 0.;
	...
	this.getNameOfDish = function(type) {
		if(this.getDish(this.getSelectedDish(type)) != null) {
	...
	this.getPriceOfDish = function(type) {
		if(this.getDish(this.getSelectedDish(type)) != null) {
		var ingredients = this.getDish(this.getSelectedDish(type)).ingredients;
		return this.getPriceHelper(ingredients);
		} else {
			return "";
		}
	}
	...
	/*this.getNameOfDish = function(id) {
		if(this.getDish(id) != null) {
		alert(this.getDish(id).name);
